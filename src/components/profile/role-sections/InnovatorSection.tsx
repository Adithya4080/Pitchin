    ...
    return (
      <Card className="border-2 border-dashed border-border/50 bg-muted/5">
        <CardContent className="py-8 text-center">
          <h3 className="text-sm font-bold text-foreground mb-1.5">Skills \& Portfolio</h3>
          <p className="text-xs text-muted-foreground">Add your skills, achievements, and featured projects.</p>
        </CardContent>
      </Card>
    );
  }
