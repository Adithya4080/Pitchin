...
export function InvestorSection({
  ...
  // Always render - show empty state for owner
    ...
    return (
      <Card className="border-2 border-dashed border-border/50 bg-muted/5">
        <CardContent className="py-8 text-center">
          <h3 className="text-sm font-bold text-foreground mb-1.5">Investment Info</h3>
          <p className="text-xs text-muted-foreground mb-4">Add your investor type, investment range, preferred sectors, and criteria.</p>
        </CardContent>
      </Card>
    );
  }
