    ...
    return (
      <Card className="border-2 border-dashed border-border/50 bg-muted/5">
        <CardContent className="py-8 text-center">
          <h3 className="text-sm font-bold text-foreground mb-1.5">Expertise</h3>
          <p className="text-xs text-muted-foreground">Add your expertise areas, experience summary, and services offered.</p>
        </CardContent>
      </Card>
    );
  }
