...
interface MobileProfileViewProps {
  ...
  fundingSection?: ReactNode;
  tractionSection?: ReactNode;
  trustPressSection?: ReactNode;
  profileStrengthSection?: ReactNode;
    ...
    <div className="min-h-screen bg-background pb-24 w-full max-w-full overflow-x-hidden">
        ...
        <div className="relative">
          {isOwnProfile && (
            <Button
              ...
              className="absolute top-6 right-6 h-8 w-8 p-0 z-20 bg-background/90 hover:bg-background border border-border/50 shadow-sm"
            >
      ...
      {profileStrengthSection && (
        <motion.div
          ...
          className="mt-1 w-full bg-card border-t border-border/30 px-4 py-4"
        >
          {profileStrengthSection}
        </motion.div>
      )}
      ...
      {/* Company Portfolio Section - after trust/press, before team */}
      {portfolioSection && (
        <motion.div
          initial={{ y: 10, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
      ...
      {/* Team Section - After company portfolio */}
      {teamSection && (
        <motion.div
          initial={{ y: 10, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
