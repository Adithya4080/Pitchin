...
//               {p.industry_tags?.length > 0 && <TagList items={p.industry_tags} />}
//             </CardContent>
//           </Card>
//         )}
...
//               <Separator />
//               <div className="grid grid-cols-2 gap-4 text-sm">
//                 {p.funding_data.stage && (
//                   <div>
//                     <p className="text-xs text-muted-foreground uppercase tracking-wide">Stage</p>
//                     <p className="font-medium">{p.funding_data.stage}</p>
//                   </div>
//                 )}
//                 {p.funding_data.amount_raised && (
//                   <div>
//                     <p className="text-xs text-muted-foreground uppercase tracking-wide">Raised</p>
//                     <p className="font-medium">{p.funding_data.amount_raised}</p>
//                   </div>
//                 )}
//               </div>
//             </CardContent>
...
//         {/* ── Traction ──────────────────────────────────────────────────── */}
//         {p.traction_data?.metrics?.length > 0 && (
//           <Card>
//             <CardContent className="p-6 space-y-4">
//               <h2 className="font-semibold text-foreground flex items-center gap-2">
...
//                 {p.traction_data.metrics.map((m: any, i: number) => (
...
//               <Separator />
//               <div className="space-y-3">
//                 {p.team_members.map((m: any, i: number) => (
