...
const CONTACT_INFO = [
  { icon: Mail, label: 'Email us', value: 'pitche.saas@gmail.com', href: 'mailto:pitche.saas@gmail.com' },
  { icon: Phone, label: 'Call us', value: '+91 99999 99999', href: 'tel:+9199999999' },
...
const SOCIAL_LINKS = [
  ...
  { icon: Instagram, label: 'Instagram', href: 'https://www.instagram.com/pich.in.official' },
];
// ──────────────────────────────────────────────────────────────────────────
    ...
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      <style>{`
        ...
        .globe-arc {
          ...
          animation: arc-travel 7s linear infinite;
        }
        .globe-node-pulse {
        ...
        @media (prefers-reduced-motion: reduce) {
          .globe-rotate, .globe-arc, .globe-node-pulse { animation: none; }
        }
      `}</style>

      {/* Wireframe globe with traveling connection arcs — the "network" motif */}
      <svg
        className="absolute left-1/2 top-[-4%] -translate-x-1/2 h-[120vmin] w-[120vmin] max-w-none opacity-[0.09] text-primary"
        viewBox="0 0 600 600"
        fill="none"
      >
        <g className="globe-rotate">
          ...
          <ellipse cx="300" cy="300" rx="240" ry="60" stroke="currentColor" strokeWidth="1" />
          <ellipse cx="300" cy="210" rx="200" ry="42" stroke="currentColor" strokeWidth="1" />
          <ellipse cx="300" cy="390" rx="200" ry="42" stroke="currentColor" strokeWidth="1" />
          <ellipse cx="300" cy="300" rx="90" ry="240" stroke="currentColor" strokeWidth="1" />
          <ellipse cx="300" cy="300" rx="170" ry="240" stroke="currentColor" strokeWidth="1" />

          {/* great-circle connection routes, like flight paths between hubs */}
          <path className="globe-arc" d="M300,80 Q420,50 480,180" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
          <path className="globe-arc" d="M150,200 Q300,140 420,420" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
          <path className="globe-arc" d="M180,430 Q350,520 520,320" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
          <path className="globe-arc" d="M90,320 Q120,470 300,520" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
          ...
          {/* pulsing "active" hubs */}
          <circle className="globe-node-pulse" cx="480" cy="180" r="5" fill="currentColor" style={{ animationDelay: '0s' }} />
          <circle className="globe-node-pulse" cx="180" cy="430" r="5" fill="currentColor" style={{ animationDelay: '1.1s' }} />
          <circle className="globe-node-pulse" cx="90" cy="320" r="5" fill="currentColor" style={{ animationDelay: '1.9s' }} />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      <div className="relative px-4 sm:px-6 py-6 md:py-10 max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, ease: EASE }}
          className="text-center max-w-2xl mx-auto mb-6 md:mb-16"
        >
